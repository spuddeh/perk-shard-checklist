...
<#
.SYNOPSIS
    One-time backfill of historical GitHub Releases for Perk Shard Checklist.
...
.DESCRIPTION
    ...
    --latest=false so none of them steals "Latest" from the next real release (psc-v3.0.0+).
...
$releases = @(
    @{ artifact='psc'; version='1.0.0'; zip='perk_shard_checklist_v1.0.0.zip'; changelog=$changelog }
    @{ artifact='psc'; version='2.0.0'; zip='perk_shard_checklist_v2.0.0.zip'; changelog=$changelog }
    @{ artifact='psc'; version='2.0.1'; zip='perk_shard_checklist_v2.0.1.zip'; changelog=$changelog }
    @{ artifact='psc'; version='2.0.2'; zip='perk_shard_checklist_v2.0.2.zip'; changelog=$changelog }
)
